...
let fixture: ComponentFixture<GalleryTagFilterComponent>;
let component: GalleryTagFilterComponent;
...
describe('GalleryTagFilterComponent', () => {
  ...
  describe('unit tests', () => {
    ...
    beforeEach(async () => {
      ...
      fixture = TestBed.createComponent(GalleryTagFilterComponent);
